...
PileupWeightProducer::PileupWeightProducer(const edm::ParameterSet& pset)
{
  ...
  produces<float>("up");
  produces<float>("dn");
  produces<float>("xs71000");
  produces<float>("xs71000up");
  produces<float>("xs71000dn");
...
void PileupWeightProducer::produce(edm::Event& event, const edm::EventSetup& eventSetup)
{
  ...
  event.put(weight_71000  , "xs71000");
  event.put(weightUp_71000, "xs71000up");
  event.put(weightDn_71000, "xs71000dn");
}
