...
## sample directory
sample= "/home/jalmond/Data/periodA/"
## output name can be anything, it creates a tmp dir
output="periodA"
outputdir="/tmp_cms/jalmond_temp/"+output
...
for j in range(1,njob+1):
    ...
    configfile.write(makeNtupleMakerData(output,output+ "/"+output + "_" + str(j) + "_full.txt", output,j, False))
    configfile.close()
